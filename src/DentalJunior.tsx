...
function DentalJunior() {
  ...
  const coverageItems = [
    'Exclusivo para crianças de 0 á 17 anos',
    'Restaurações',
    'Limpeza',
    'Consulta',
    'Emergência 24h',
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#0066FF] text-white relative">
        ...
        <div className="container mx-auto px-4 py-16 flex flex-col items-center">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">PLANO DENTAL JÚNIOR</h1>
            <p className="text-xl mb-8">
              Plano exclusivo para crianças e adolescentes de 0 a 17 anos, com cobertura para limpezas, aplicação de flúor, além de tratamentos restaurativos e extração do siso.
            </p>
            <button
      ...
      <section className="py-16 container mx-auto px-4">
        <h2 className="text-2xl font-bold text-[#0066FF] mb-4">Sobre o Dental Júnior</h2>
        <p className="mb-8">
          Os cuidados com a saúde bucal devem começar desde cedo. Com o Plano Dental Júnior, incentivamos os hábitos diários e as consultas regulares, transformando esses momentos em uma experiência divertida e inspiradora.
        </p>
        ...
        <p className="mb-8">
          Plano exclusivo para crianças e adolescentes de 0 a 17 anos. O Dental Júnior conta com cobertura para limpezas, aplicação de flúor, além de tratamentos restaurativos e extração do siso.
        </p>
        ...
        <div className="mt-12">
          ...
          <p><strong>Nome comercial ANS:</strong> PLANO DENTAL JÚNIOR 1FLE</p>
          <p><strong>Registro ANS:</strong> 480.095/18-8</p>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div>
              ...
              <p className="text-4xl font-bold">
                R$ <span className="text-6xl">29</span>,90
              </p>
              <p>Mensal</p>
            </div>
            <div>
              ...
              <p className="text-4xl font-bold">
                R$ <span className="text-6xl">299</span>,00
              </p>
              <p>Anual</p>
            </div>
          </div>
