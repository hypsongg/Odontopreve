  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#0066FF] text-white relative">
        ...
        <div className="container mx-auto px-4 py-16 flex flex-col items-center">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">PLANO BEM ESTAR</h1>
            <button
      ...
      <section className="py-16 container mx-auto px-4">
        <h2 className="text-2xl font-bold text-[#0066FF] mb-4">Sobre o Bem Estar</h2>
        <p className="mb-8">
          Um sorriso saudável contribui para o bem-estar, eleva a autoestima e reforça nossa energia. O plano Bem Estar foi feito especialmente para cuidados essenciais para sua saúde bucal.
        </p>
        ...
        <p className="mb-8">
          Para pessoas que buscam os cuidados essenciais de tratamentos clínicos, como limpeza, extração de siso e tratamento de canal.
        </p>
        ...
        <div className="mt-12">
          ...
          <p><strong>Nome comercial ANS:</strong> DENTAL BEM ESTAR 1FLE</p>
          <p><strong>Registro ANS:</strong> 478.626/17-2</p>
          <p><strong>Rede Do Plano:</strong> PRINCIPAL</p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div>
              ...
              <p className="text-4xl font-bold">
                R$ <span className="text-6xl">45</span>,60
              </p>
              <p>Mensal</p>
            </div>
            <div>
              ...
              <p className="text-4xl font-bold">
                R$ <span className="text-6xl">456</span>,00
              </p>
              <p>Anual</p>
            </div>
          </div>
