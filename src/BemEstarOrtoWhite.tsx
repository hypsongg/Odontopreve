...
function BemEstarOrtoWhite() {
  const [isMenuOpen, setIsMenuOpen] = useState(false);
  
  const handleBuyClick = () => {
    window.location.href = 'https://pagamento.odontoprev.site/checkout?product=bd6342f4-f528-11ef-8446-46da4690ad53';
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-[#0066FF] text-white relative">
        ...
        <div className="container mx-auto px-4 py-16 flex flex-col items-center">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold mb-4">PLANO BEM ESTAR ORTO WHITE</h1>
            <p className="text-xl mb-8">
              Plano completo para cuidar da sua saúde bucal com qualidade e segurança. Além dos cuidados clínicos, a cobertura é ampla para clareamento estético em gel (feito em consultório ou de forma caseira, a partir do diagnóstico clínico) e tratamentos ortodônticos
            </p>
            <button
      ...
      <section className="py-16 container mx-auto px-4">
        <h2 className="text-2xl font-bold text-[#0066FF] mb-4">Sobre o Bem Estar Orto White</h2>
        <p className="mb-8">
          Um sorriso saudável contribui para o bem-estar, eleva a autoestima e revigora nossa energia. O plano Bem-estar Orto White foi feito especialmente para a manutenção dos cuidados com sua saúde bucal e tratamentos ortodônticos completos. Feito para inspirar seu melhor sorriso!
        </p>
        ...
        <p className="mb-8">
          A garantia de um plano completo para cuidar da sua saúde bucal com qualidade e segurança. Além dos cuidados clínicos, a cobertura é ampla para clareamento estético e tratamentos ortodônticos completos, incluindo documentação e manutenção.
        </p>
        ...
        <div className="mt-12">
          ...
          <p><strong>Nome comercial ANS:</strong> BEM ESTAR ORTO WITHE 1FLE</p>
          <p><strong>Registro ANS:</strong> 495.362/23-2</p>
          ...
          <div className="mt-8">
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border-2 border-[#0066FF]">
              <div className="mb-6">
                ...
                <p>90 dias para Clínico Geral e 180 dias para clareamento em Gel, Ortodontia e Prótese</p>
              </div>
              <div>
                <h3 className="text-xl font-bold text-[#0066FF] mb-2">No plano Anual</h3>
                <p>60 dias para Clínico Geral e 90 dias para clareamento em Gel, Ortodontia e Prótese + Desconto de 2 parcelas</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8">
            <div>
              ...
              <p className="text-4xl font-bold">
                R$ <span className="text-6xl">159</span>,90
              </p>
              <p>Mensal</p>
            </div>
            <div>
              ...
              <p className="text-4xl font-bold">
                R$ <span className="text-6xl">1.599</span>,00
              </p>
              <p>Anual</p>
            </div>
          </div>
...
export default BemEstarOrtoWhite;